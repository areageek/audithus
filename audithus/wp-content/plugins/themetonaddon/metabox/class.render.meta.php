    ...
    public static function getField($params){
        ...
        switch ($type) {
            case 'title':
                ...
                break;
            case 'colorpicker':
                return '<input type="text" ' . $gatts . ' value="' . esc_attr($value) . '" class="themeton_wpcolorpicker" data-default-color="' . $default . '" />';
                break;
            case 'text':
            ...
            case 'textarea':
                ...
                break;
            case 'select':
                $html = '<select ' . $gatts . ' default-value="' . esc_attr($value) . '" class="themeton_wpselectbox">';
            ...
            case 'radio':
                $html = '';
                foreach ($option as $key => $val) {
                    $html .= '<input type="radio" group="themeton_group_' . esc_attr($name) . '" ' . $gatts . ' class="themeton_wpradiobox" ' . ($value == $key ? 'checked' : '') . '>';
                    $html .= $val . '<br>';
                }
                return $html;
                break;
            case 'icon':
                $html = '';
                foreach ($option as $key => $val) {
                    $html .= '<input type="radio" group="themeton_group_' . esc_attr($name) . '" ' . $gatts . ' class="themeton_wpradiobox" ' . ($val == $key ? 'checked' : '') . '>';
                    $html .= $val;
                    if ($key == 'custom')
            ...
            case 'thumbs':
                ...
                foreach ($option as $key => $val) {
                    $ndx++;
                    $html .= '<input type="radio" group="themeton_group_' . esc_attr($name) . '" name="' . esc_attr($name) . '" id="' . esc_attr($name . $ndx) . '" value="' . esc_attr($key) . '" class="themeton_wpradiobox" ' . ($key == $value ? 'checked' : '') . '>';
            ...
            case 'background':
                ...
                $html .= '<div class="pmeta_item_background">
                                ...
                                <div class="background-controlls" style="'.($values['url']=='' ? 'display:none;' : '').'">
                                    <select id="'.esc_attr($name).'_repeat" name="'.esc_attr($name).'_repeat" default-value="'.esc_attr($values['repeat']).'" class="themeton_wpselectbox bg_image_repeat">
                                    ...
                                    <select id="'.esc_attr($name).'_position" name="'.esc_attr($name).'_position" default-value="'.esc_attr($values['position']).'" class="themeton_wpselectbox bg_image_position">
                                    ...
                                    <select id="'.esc_attr($name).'_attach" name="'.esc_attr($name).'_attach" default-value="'.esc_attr($values['attach']).'" class="themeton_wpselectbox bg_image_attach">
