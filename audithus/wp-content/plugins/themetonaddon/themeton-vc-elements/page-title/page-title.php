...
if (!class_exists('WPBakeryShortCode_page_title')) {
class WPBakeryShortCode_page_title extends WPBakeryShortCode {
    ...
    protected function content( $atts, $content = null){
        ...
        $css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, vc_shortcode_custom_css_class( $css, ' ' ), 'page_title', $atts );
        ...
        return sprintf("<h1 class='uk-article-title page-title %s' %s>%s</h1>",$extra_class,$style,Themeton_Tpl::get_page_title());
    }
}
}

vc_map( array(
    "name" => esc_html__('Page Title', 'themetonaddon'),
    "description" => esc_html__("page title", 'themetonaddon'),
    "base" => 'page_title',
