<?php
if (!class_exists('WPBakeryShortCode_woo_price')) {
class WPBakeryShortCode_woo_price extends WPBakeryShortCode {
    ...
    protected function content( $atts, $content = null){
        ...
        $css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, vc_shortcode_custom_css_class( $css, ' ' ), 'woo_price', $atts );
        ...
        $content = '<span class="'.$extra_class.'" '.$style.'>'.$product->get_price_html().'</span>';
        return $content;
    }
}
}
...
vc_map( array(
    "name" => esc_html__('Price', 'themetonaddon'),
    "description" => esc_html__("Woocommerce Single Price", 'themetonaddon'),
    "base" => 'woo_price',
