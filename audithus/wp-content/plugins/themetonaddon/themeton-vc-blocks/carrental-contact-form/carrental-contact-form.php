...
return array(
	'name' => esc_html__( 'carrental contact form', 'themetonaddon' ),
	'image_path' => 'http://themeton.com/themetonaddon/themeton-vc-blocks/'.basename(dirname(__FILE__)).'/'.'carrental-contact-form.jpg',
