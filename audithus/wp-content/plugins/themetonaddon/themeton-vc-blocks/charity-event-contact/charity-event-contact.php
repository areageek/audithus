...
return array(
	'name' => esc_html__( 'charity event contact', 'themetonaddon' ),
	'image_path' => 'http://themeton.com/themetonaddon/themeton-vc-blocks/'.basename(dirname(__FILE__)).'/'.'charity-event-contact.jpg',
