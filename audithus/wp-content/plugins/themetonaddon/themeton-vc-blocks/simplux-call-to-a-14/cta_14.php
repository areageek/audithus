...
return array(
	'name' => esc_html__( 'Creative call to actions cta_14', 'themetonaddon' ),
	'image_path' => 'http://themeton.com/themetonaddon/themeton-vc-blocks/'.basename(dirname(__FILE__)).'/'.'cta_14.png',
