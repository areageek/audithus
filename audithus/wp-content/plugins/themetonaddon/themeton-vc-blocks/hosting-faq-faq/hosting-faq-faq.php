...
return array(
	'name' => esc_html__( 'hosting faq faq', 'themetonaddon' ),
	'image_path' => 'http://themeton.com/themetonaddon/themeton-vc-blocks/'.basename(dirname(__FILE__)).'/'.'hosting-faq-faq.jpg',
