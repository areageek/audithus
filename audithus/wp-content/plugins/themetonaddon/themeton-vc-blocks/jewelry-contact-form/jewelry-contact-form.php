...
return array(
	'name' => esc_html__( 'jewelry contact form', 'themetonaddon' ),
	'image_path' => 'http://themeton.com/themetonaddon/themeton-vc-blocks/'.basename(dirname(__FILE__)).'/'.'jewelry-contact-form.jpg',
