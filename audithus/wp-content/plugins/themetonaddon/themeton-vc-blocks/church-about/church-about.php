...
return array(
	'name' => esc_html__( 'church about', 'themetonaddon' ),
	'image_path' => 'http://themeton.com/themetonaddon/themeton-vc-blocks/'.basename(dirname(__FILE__)).'/'.'church-about.jpg',
...
[/vc_column_text][/vc_column][vc_column width="1/6"][/vc_column][/vc_row][vc_row vc_row_height="457px" css=".vc_custom_1518418765765{margin-top: 20px !important;margin-bottom: 100px !important;background-position: center !important;background-repeat: no-repeat !important;background-size: cover !important;}"][vc_column][video_player width="1200" height="500" url="https://www.youtube.com/watch?v=Qdr7u6IP6sg"][/vc_column][/vc_row]
CONTENT
);