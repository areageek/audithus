...
if ( !function_exists( 'wbc_importer_description_text' ) ) {
	...
	function wbc_importer_description_text( $description ) {
		...
		$message = '<p>'. esc_html__( 'Best if used on new WordPress install.', 'medio' ) .'</p>';
		$message .= '<p>'. esc_html__( 'Images are for demo purpose only.', 'medio' ) .'</p>';
		...
		if ( class_exists( 'RevSlider' ) ) {
			...
			$wbc_sliders_array = array(
				'medio' => array(
					...
					'http://themeton.com/oneclick/medio/testimonials.zip'
				)
			);
