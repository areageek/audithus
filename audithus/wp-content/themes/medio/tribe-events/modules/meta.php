...
if ( ! $set_venue_apart && ! tribe_embed_google_map() ) {
	...
	echo '<div class="uk-width-expand tribe-events-meta-group tribe-events-meta-group-gmap">';
	tribe_get_template_part( 'modules/meta/venue' );
	echo '</div>';
...
<?php if ( $set_venue_apart ) : ?>
	<?php if ( $not_skeleton ) : ?>
		<div class="uk-grid tribe-events-single-section tribe-events-event-meta secondary tribe-clearfix">
	<?php endif; ?>
	<?php
