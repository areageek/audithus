 ...
 * @var int Event post id
 */
$time_title = apply_filters( 'tribe_events_single_event_time_title', esc_html__( 'Time:', 'medio' ), $event_id );
	...
	<div class="tribe-events-meta-group tribe-events-meta-group-details">
		...
		<dl>
			...
			if ( tribe_event_is_all_day() && tribe_event_is_multiday() ) :
				?>
				<dt> <?php esc_html_e( 'Start:', 'medio' ) ?> </dt>
				<dd>
				...
				<dt> <?php esc_html_e( 'End:', 'medio' ) ?> </dt>
				<dd>
			...
			elseif ( tribe_event_is_all_day() ):
				...
				<dt> <?php esc_html_e( 'Date:', 'medio' ) ?> </dt>
				<dd>
					<abbr class="tribe-events-abbr tribe-events-start-datetime published dtstart" title="<?php echo esc_attr( $start_ts ) ?>"> <?php echo esc_html( $start_date ) ?> </abbr>
				</dd>
			...
			if ( ! empty( $cost ) ) : ?>
				...
				<dt> <?php esc_html_e( 'Cost:', 'medio' ) ?> </dt>
			...
			<?php echo tribe_meta_event_tags( sprintf( esc_html__( '%s Tags:', 'medio' ), tribe_get_event_label_singular() ), ', ', false ) ?>

			<?php
			// Event Website
			if ( ! empty( $website ) ) : ?>

				<dt> <?php esc_html_e( 'Website:', 'medio' ) ?> </dt>
