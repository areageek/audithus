...
function themeton_sanitize_js_clean( $value ) {
    $value = preg_replace('/<script\b[^>]*>(.*?)<\/script>/is', "", $value);
    return $value;
}

class Medio_Theme_Customizer{
    private $items;
    ...
    public function enqueue_scripts(){
        ...
        $fonts = Themeton_Std::google_fonts();
        ...
        foreach ($items as $control) {
            if( isset($control['type']) && ($control['type']=='font_set' || $control['type']=='font') ){
                ...
                $values = array();
                $option_val = Themeton_Std::get_mod( $control['id'], $control['default'] );

                if( $control['type']=='font_set' )
                    $values = Themeton_Std::get_option_array($option_val);
                else
        ...
        if( !empty($webfonts) ){
            ...
            wp_enqueue_style("medio-google-web-fonts", esc_url($fonts_url));
        }
    }
    ...
    public function generate_setting($wp_customize, $control, $section_id=false){
        ...
        $wp_customize->add_setting($control['id'], array(
            ...
            'capability' => 'edit_theme_options',
            'sanitize_callback' => 'themeton_sanitize_js_clean'
        ));
            ...
            switch( $control['type'] ){
                ...
                case "image":
                    $wp_customize->add_control(
                        new Medio_Customizer_Image_Control( $wp_customize, $control['id'],
                           array(
                               'label'      => $control['label'],
                               'section'    => $section_id,
                               'settings'   => $control['id'],
                ...
                case "bg_image":
                    $wp_customize->add_control(
                        new Medio_Customizer_Bg_Image_Control( $wp_customize, $control['id'],
                           array(
                               'label'      => $control['label'],
                               'section'    => $section_id,
                               'settings'   => $control['id'],
                ...
                case "switch":
                    $wp_customize->add_control(
                        new Medio_Customizer_Switch_Control( $wp_customize, $control['id'],
                           array(
                               'label'      => $control['label'],
                               'section'    => $section_id,
                               'settings'   => $control['id'],
                ...
                case "pixel":
                    $wp_customize->add_control(
                        new Medio_Customizer_Number_Pixel_Control( $wp_customize, $control['id'],
                           array(
                               'label'      => $control['label'],
                               'section'    => $section_id,
                               'settings'   => $control['id'],
                ...
                case "sub_title":
                    $wp_customize->add_control(
                        new Medio_Customizer_Sub_Title_Control( $wp_customize, $control['id'],
                           array(
                               'label'      => $control['label'],
                               'section'    => $section_id,
                               'settings'   => $control['id'],
                ...
                case "font_set":
                    $wp_customize->add_control(
                        new Medio_Customizer_Font_Set_Control( $wp_customize, $control['id'],
                           array(
                               'label'      => $control['label'],
                               'section'    => $section_id,
                               'settings'   => $control['id'],
                ...
                case "font_group":
                    $wp_customize->add_control(
                        new Medio_Customizer_Font_Group_Control( $wp_customize, $control['id'],
                           array(
                               'label'      => $control['label'],
                               'section'    => $section_id,
                               'settings'   => $control['id'],
                ...
                case "font":
                    $wp_customize->add_control(
                        new Medio_Customizer_Font_Control( $wp_customize, $control['id'],
                           array(
                               'label'      => $control['label'],
                               'section'    => $section_id,
                               'settings'   => $control['id'],
                ...
                case "backup":
                    $wp_customize->add_control(new Medio_Customizer_Backup_Control($wp_customize, $control['id'], array(
                         'label' => $control['label'],
                         'section' => $section_id,
                         'settings' => $control['id'],
                         'priority' => $setting_index,
                ...
                case "import":
                    $wp_customize->add_control(new Medio_Customizer_Import_Control($wp_customize, $control['id'], array(
                         'label' => $control['label'],
                         'section' => $section_id,
                         'settings' => $control['id'],
                         'priority' => $setting_index,
